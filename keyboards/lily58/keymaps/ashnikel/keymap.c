...
// #undef PIMORONI_TRACKBALL_INTERVAL_MS
// #define PIMORONI_TRACKBALL_INTERVAL_MS 1
...
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    | Ins  | PgUp | PgDn | Home | End  |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |                    |   6  |   7  |   8  |   9  |   0  |  `   |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |   !  |Mouse3|Mouse2|Mouse1|   %  |-------.    ,-------| Left | Down |  Up  |Right |   {  |   }  |
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|   -  |   _  |   =  |   +  |   \  |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | LGUI |LOWER | /Space  /       \ ESC  \  |RAISE |Delete| RGUI |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_LOWER] = LAYOUT( \
  _______, _______, _______, _______, _______, _______,                   KC_INS,  KC_PGUP, KC_PGDN, KC_HOME, KC_END, _______,\
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_6,   KC_7,   KC_8,   KC_9,  KC_0,  KC_GRV, \
  _______, KC_EXLM, KC_BTN3, KC_BTN2, KC_BTN1,  KC_PERC,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_LCBR, KC_RCBR, \
  _______, _______, _______, _______, _______, _______, _______, _______, KC_MINS, KC_UNDS, KC_EQL, KC_PLUS, KC_BSLS, _______, \
 ...
 */
  [_ADJUST] = LAYOUT( \
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   BALL_HUI, BALL_WHT, BALL_DEC, XXXXXXX, XXXXXXX, XXXXXXX, \
